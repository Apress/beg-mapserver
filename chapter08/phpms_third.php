...
if (( $_POST['img_x'] and $_POST['img_y'] ) 
   ...
   if ( $_POST['refresh'] ) { // Refresh, fake the coordinates
      $clickx = 320;
      $clicky = 240;
   ...
   if ( $_POST['layer'] ) {                // any layers selected?
      $layers = join(" ",$_POST['layer']); // yes
   } else {
      $layers = "";                        // no
   }
   $this_layer = 0;
   ...
   <tr><td width="60%" rowspan="6">
       ...
       <td width="40%" align="center" colspan="3">
         <img SRC="<?php echo $ref_url;?>" 
          width=300 height=225 border=1></td></tr>
   ...
   <tr><td rowspan="2"><img src="<?php echo $leg_url;?>"></td>
       ...
       <td align="top">
         ...
         <input type="checkbox" name="layer[]" value="roads" 
           <?php echo $roads;?> >Roads<br></font></td></tr>
